...
RSpec.describe '/groups', type: :request do
  ...
  context 'when signed in' do
    ...
    let(:valid_attributes) do
      { name: 'this is a name', notes: 'this is a note' }
    end

    let(:invalid_attributes) do
      { title: 'this is a name', notess: 'this is a note' }
    end
    ...
    describe 'PATCH /update' do
      context 'with valid parameters' do
        let(:new_attributes) do
          { name: 'this is a name 2', notes: 'this is a note 2' }
        end
        ...
        it 'updates the requested group' do
          ...
          group.reload
          expect(group.name).to eq('this is a name 2')
          expect(group.notes).to eq('this is a note 2')
        end
